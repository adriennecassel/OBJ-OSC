...
private var cube_x : float = 0;
private var cube_y : float = 0;
private var cube_z : float = 0;
...
function Update () {
    ...
    // var move_head = GameObject.Find("me-composite_rig/Hips/torso/Neck/head"); 
    // var move_torso = GameObject.Find("me-composite_rig/Hips/torso"); 

 	//var move_Lhip = GameObject.Find("me-composite_edit1/Rig/Lhip");
    //move_Lhip.transform.position = Vector3(Lhip_x, Lhip_z,(Lhip_y));
 // 	var move_Lshoulder = GameObject.Find("me-composite_edit1/Rig/torso/Lshoulder");
 //    move_Lshoulder.transform.position = Vector3(Lshoulder_x, Lshoulder_z, (Lshoulder_y));
 //    var move_Larm = GameObject.Find("me-composite_edit1/Rig/torso/Lshoulder/Larm");
 //    move_Larm.transform.position = Vector3(Larm_x, Larm_z, (Larm_y));
 //    var move_Lforearm = GameObject.Find("me-composite_edit1/Rig/torso/Lshoulder/Larm/Lforearm");
 //    move_Lforearm.transform.position = Vector3(Lforearm_x, Lforearm_z, (Lforearm_y));
 //    var move_Lleg = GameObject.Find("me-composite_edit1/Rig/Lhip/Lthigh/Lleg");
 //    move_Lleg.transform.position = Vector3(Lleg_x, Lleg_z, (Lleg_y));
 //    var move_Lhand = GameObject.Find("me-composite_edit1/Rig/torso/Lshoulder/Larm/Lforearm/Lhand");
 //    move_Lhand.transform.position = Vector3(Lhand_x, Lhand_z, (Lhand_y));
	// var move_Lfoot = GameObject.Find("me-composite_edit1/Hips/Lthigh/Lleg/Lfoot");
 //    move_Lfoot.transform.position = Vector3(Lfoot_x, Lfoot_z, (Lfoot_y)); 
    
 //    var move_Rhip = GameObject.Find("me-composite_edit1/Rig/Rhip");
 //    move_Rhip.transform.position = Vector3(Rhip_x, Rhip_z, (Rhip_y));
 //    var move_Rshoulder = GameObject.Find("me-composite_edit1/Rig/torso/Rshoulder");
 //    move_Rshoulder.transform.position = Vector3(Rshoulder_x, Rshoulder_z, (Rshoulder_y));
 //    var move_Rarm = GameObject.Find("me-composite_edit1/Rig/tors/Rshoulder/Rarm");
 //    move_Rarm.transform.position = Vector3(Rarm_x, Rarm_z, (Rarm_y));
 //    var move_Rforearm = GameObject.Find("me-composite_edit1/Rig/torso/Rshoulder/Rarm/Rforearm");
 //    move_Rforearm.transform.position = Vector3(Rforearm_x, Rforearm_z, (Rforearm_y));
 //    var move_Rleg = GameObject.Find("me-composite_edit1/Rig/Rhip/Rthigh/Rleg");
	// move_Rleg.transform.position = Vector3(Rleg_x, Rleg_z, (Rleg_y));
 //    var move_Rhand = GameObject.Find("me-composite_edit1/Rig/torso/Rshoulder/Rarm/Rforearm/Rhand");
 //    move_Rhand.transform.position = Vector3(Rhand_x, Rhand_z, (Rhand_y));
 //    var move_Rfoot = GameObject.Find("me-composite_edit1/Rig/Rhip/Rthigh/Rleg/Rfoot");
 //    move_Rfoot.transform.position = Vector3(Rfoot_x, Rfoot_z, (Rfoot_y));
    ...
    var move_cube = GameObject.Find("Cube");
    move_cube.transform.position = Vector3(cube_x, cube_y, cube_z);
    //Debug.Log(move_cube);
...
//    }
  ...
  //  Debug.Log(Rhip_x); // null reference here ******
    ...
    //var lhip = GameObject.Find("Cube");
    //lhip.transform.position = Vector3(Lhip_x, Lhip_z,(Lhip_y));
    updateSubscriptions();
